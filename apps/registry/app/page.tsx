...
const VARIANTS = [
  ...
  },
  {
    ...
    description: "Success, error, warning and info with semantic colors + icons.",
    Preview: ToastTypes,
  },
  {
    key: "description",
...
export default async function Home() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <section className="mb-14 border-b pb-14">
        <div className="inline-flex items-center gap-2 rounded-full border bg-background py-1 pl-1.5 pr-3 text-xs font-medium">
          ...
          Works with React <span className="text-muted-foreground">&</span> Vue
        </div>
        ...
        <p className="mt-4 max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground">
          Hand-built toasts you actually own — no black boxes. One command
          drops the source straight into your{" "}
          <span className="font-semibold text-foreground">React</span> or{" "}
          <span className="font-semibold text-foreground">Vue</span> app. One
          design, both frameworks.
        </p>
